const BadProfile = ({ user }) => {
  ...
  return (
    <div className="grid sm:grid-cols-3 sm:p-[5vw] " >
      <img src={info[5]} alt="User" className="w-[15vh] bg-[#53AFEE] h-[15vh] sm:w-[12vw] sm:h-[12vw] object-cover rounded-[50%] border-4 border-green-500 row-span-2 justify-self-center"/>
      <div className="grid pl-[5vw] sm:pl-0 justify-self-center sm:justify-self-start sm:col-span-2">
